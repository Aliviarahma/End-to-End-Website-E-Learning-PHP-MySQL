...
<link rel="resource" type="application/l10n" href="<?php echo web_root; ?>locale/locale.properties">
<script src="<?php echo web_root; ?>build/pdf.js"></script>  
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '<?php echo web_root; ?>build/pdf.worker.js';
  PDFJS.cMapUrl = '<?php echo web_root; ?>web/cmaps/';
...
var DEFAULT_URL ='<?php echo $res->FileLocation; ?>';
;
